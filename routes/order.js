...
// uuid έχουν τα cartItems του Cart, οπότε μπορούμε να χρησιμοποιήοσουμε το cart[0].id για αυτό το σκοπό.
...
// μην τυχόν και φτάσει στον browser πρώτα η απόρριψη και γίνει μετά η αποδοχή της παραγγελίας. 
